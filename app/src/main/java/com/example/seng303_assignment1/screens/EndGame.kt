...
fun EndGame(
    ...
    val flashCards by playViewModel.gameResults.collectAsState()
    val correctAnswersTotal by playViewModel.correctAnswersTotal.collectAsState()
    ...
    if (flashCards.isNotEmpty()) {
        Column {
            Row(
                ...
                Text(
                    text = "Score: $correctAnswersTotal / ${flashCards.size}",
